...
public class ReminderFragment extends AppDefaultFragment {
    ...
    private AppCompatSpinner mSnoozeSpinner;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mSnoozeSpinner = (AppCompatSpinner) view.findViewById(R.id.todoReminderSnoozeSpinner);
...
//        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, snoozeOptionsArray);
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), R.layout.spinner_dropdown_item, snoozeOptionsArray);
